...
export const E02_AUDIO_VISUAL_FIXTURES = Object.freeze({
  ...
  digitalSilence: { ...base, transcription: { state: 'completed' as const, receipt: { localRequests: 0 as const, providerAttempts: 0, costChargedUsd: 0, resolvedModel: null, reconciliationPending: false }, result: { status: 'no_speech' as const, text: '', uncertainties: [], origin: 'deterministic' as const, detectorVersion: 'wav-pcm16-zero.v1' as const } }, review: { state: 'awaiting_review' as const, selectedVersion: 1, versions: [{ version: 1, origin: 'deterministic' as const, detectorVersion: 'wav-pcm16-zero.v1' as const, text: '', createdAt: '2026-09-24T12:00:00Z', status: 'no_speech' as const }] } },
