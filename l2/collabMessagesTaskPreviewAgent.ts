/// <mls shortName="collabMessagesTaskPreviewAgent" project="102025" enhancement="_100554_enhancementLit" />
...
export class CollabMessageTaskPreviewAgent extends CollabLitElement {
    ...
    private async getDescription() {
        ...
        try {
            const agent = await getAgentInstanceByName(this.step.agentName);
            if (!agent) return;
